 ...
 *	(5) GROUP_END：the virtual node for the exit of the some statements (if,	switch, while, do..while, 
 *		for, enhanced for, label, synchronize, try);
 ...
 *	(8) METHOD_CALL：The node includes a method call
 *	(9) NORMAL：The node is a normal execution point
